...
export class Ui {
    ...
    rgbaManipulationGui = () => {
        if (!("rgbaManipulationGui" in this._processingTracker)) {
            ...
            let pseudolayer = this._constructor.rgbaManipulation({
                webgl: this._webgl, 
                rgbam_image: this.activeUiLayer.pseudolayer,
                rgbam_multiplier: rgbam_multiplier,
            });
            this._processingTracker["rgbaManipulationGui"] = pseudolayer;
        } else {
        ...
        function addSliderEvent(sliderId, valueId, ui) {
            document.getElementById(sliderId).oninput = () => {
                ...
                ui.updateUiLayer(ui.activeUiLayer, targetPseudolayer);
            }
        }
