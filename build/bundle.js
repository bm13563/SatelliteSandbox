(function (factory) {
    ...
    var canvasToImageData = function canvasToImageData(selector) {
      var canvas = document.querySelector(selector);
      var context = canvas.getContext('2d');
      return context.getImageData(0, 0, canvas.width, canvas.height);
    };
    var imageDataToCanvas = function imageDataToCanvas(selector, data) {
      var canvas = document.querySelector(selector);
      var context = canvas.getContext('2d');
    ...
    testMap.on("postrender", function () {
      var imageData = canvasToImageData("#tile_map canvas");
      imageDataToCanvas("#canvas_map", imageData);
    });
